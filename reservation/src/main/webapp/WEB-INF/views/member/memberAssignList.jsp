...
<c:set var="currentUser" value="${sessionScope.sId}" />
	...
	<div class="container">
        <div class="row mt-4">
          <div class="col">
            <h2><img src="${pageContext.request.contextPath }/resources/images/mypage/myAssignList.jpg" alt="" style="width: 100%;" class="justify-content-center"></h2>
          </div>
        </div>
    </div>
   	...
   	<div class="row">
        <div class="col-2" style="margin-top: 60px;">
            ...
            <div class="btn-group-vertical btn-group-lg d-flex align-self-start" role="group" aria-label="Vertical button group">
                ...
                <button type="button" class="btn btn-outline-dark active p-3" onclick="location.href='memberAssignList'">판매 내역</button>
                            ...
                            <td>
						     ...
						     <td>
					     	    ...
					     	    <c:choose>
				                    <c:when test="${resList.r_status eq 5}">
								        <div>
								        	<input type="text" class="salesValue2" id="salesValue2${resList.r_idx}" placeholder="가격을 입력하세요" maxlength="10">
								        </div>
								    </c:when>
								    <c:when test="${resList.r_status eq 1}">
